<div class="page-content">
    <div class="holder mt-0 py-3 py-sm-5 py-md-10 bg-cover lazyload" data-bgset="<?= base_url() ?>asset/images/pages/about-bg.jpg">
      <div class="container">
        <div class="row">
          <div class="col-11 col-md-9 col-xl-9">
            <div class="page-title-bg py-md-3 py-xl-6">
              <h1>ABOUT US</h1>
              <p class="d-none d-md-block">We are a professional exporter supplier from Indonesia established in 2013 also known as PT. ALSHARIF GROUP INDONESIA and subsequently PT. ALSHARIF JAYA GROUP as the trademark holder.</p>
              <p>ALSHARIF GROUP has adapted trust and integrity. as a leading distributor and commodity in Indonesia. Our clients and suppliers not only provide immediate and reliable service but also consistently exceed expectations and goals.<br>
                Over the years ALSHARIF GROUP has provided support and services to all major industries, markets and traders in the Indonesian region.</p>
              <p class="d-none d-md-block"><i><b style="color: #fff;">Our support is available 10.00 – 18.00 GMT + 2 (Monday – Friday).<br>
