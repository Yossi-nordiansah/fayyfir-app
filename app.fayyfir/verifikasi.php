          ...
          <div class="flex items-center justify-between gap-1 flex-wrap">
            ...
            <div class="flex items-center gap-1 flex-nowrap">
              ...
              <form method="POST" onsubmit="return confirm('Apakah Anda yakin ingin membatalkan verifikasi dan mengembalikan status kontainer ke Full?');" class="inline">
                ...
                <button type="submit" name="revert_status" class="bg-red-500 hover:bg-red-600 text-white text-xs px-2 py-1 rounded text-nowrap whitespace-nowrap" title="Kembalikan status ke Full (Batal Verifikasi)">Batal Verif</button>
              </form>
              <!-- Tombol Nomor -->
              ...
              <form method="POST" onsubmit="return confirm('Apakah Anda yakin kontainer tersebut telah diterima?');" class="inline">
                <input type="hidden" name="container_id" value="<?= $row["id"] ?>">
                <button type="submit" name="mark_accepted" class="bg-green-500 hover:bg-green-600 text-white text-xs px-2 py-1 rounded whitespace-nowrap">Tandai Diterima</button>
              </form>
            </div>
          </div>
