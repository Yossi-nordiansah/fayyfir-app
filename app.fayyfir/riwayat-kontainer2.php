...
<body class="bg-gray-100 text-gray-800 min-h-screen">
  <header class="bg-gray-900 text-white py-4 px-6 fixed top-0 left-0 right-0 z-40">
    <div class="flex justify-between items-center">
      ...
      <?php endif; ?>
      <?php if (isset($kontainer) && $kontainer["status"] === "accepted"): ?>
        <a href="sudah-diterima" class="flex items-center space-x-1 text-yellow-400 hover:underline text-sm">
          <span class="material-symbols-outlined text-base">chevron_left</span>
          <span class="hidden lg:inline">Kembali</span>
        </a>
      <?php endif; ?>
      <?php if (isset($kontainer) && $kontainer["status"] === "lunas"): ?>
        <a href="lunas" class="flex items-center space-x-1 text-yellow-400 hover:underline text-sm">
          <span class="material-symbols-outlined text-base">chevron_left</span>
          <span class="hidden lg:inline">Kembali</span>
        </a>
      <?php endif; ?>
  ...
  <main class="pt-20 px-4 pb-32 max-w-6xl mx-auto">
  ...
  <script>
    ...
    function showTrxModalAdmin(data) {
      ...
      document.getElementById('btnEditAdmin').href = 'edit-transaksi-admin2-2.php?id=' + data.id;
    ...
    function showTrxModal(data) {
      ...
      document.getElementById('btnEdit').href = 'edit-transaksi2.php?id=' + data.id;
    ...
    function showKtnModal(data) {
      ...
      // Edit button (optional)
      document.getElementById('btnEdit3').href = 'edit-kontainer2.php?id=' + data.id2;
    ...
    function showOprModal(data) {
      ...
      // Edit & Delete button (optional)
      document.getElementById('btnEdit2').href = 'edit-pengeluaran2.php?id=' + data.id;
