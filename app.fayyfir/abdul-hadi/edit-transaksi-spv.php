...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $stmt = $conn->prepare("UPDATE transactions SET transaction_date=?, driver_name=?, driver_phone=?, vehicle_plate=?, sack_count=?, weight_kg=?, price_per_kg=$harga_asli, grand_total=?, notes=?, supplier_id=? WHERE id=?");
  $stmt->bind_param("ssssiiisii", $date, $driver_name, $driver_phone, $vehicle_plate, $sack_count, $weight, $grand_total, $notes, $supplier_id, $transaction_id);
