      ...
      <table class="min-w-full divide-y divide-gray-200 text-sm">    
        <tbody class="text-gray-700 text-sm divide-y divide-gray-200">    
          ...
          <tr>    
            ...
            <td>:</td>    
            <td class="px-4 py-2"><?= number_format($material["total_quantity"], 0, ',', '.') ?> <?= htmlspecialchars($material["unit"]) ?></td>    
          </tr>    
          <tr>    
          ...
          <tr>    
            ...
            <td>:</td>    
            <td class="px-4 py-2 font-semibold text-green-700">Rp <?= number_format($material["total_value"], 0, ',', '.') ?></td>    
          </tr>    
        </tbody>    
      </table>    
          ...
          <tbody id="logMaterialTable" class="text-gray-800 divide-y divide-gray-200">    
            ...
            <?php foreach ($log_material as $lm): ?>    
              <tr class="log-row hover:bg-gray-100">    
                ...
                <td class="px-4 py-2 text-left whitespace-nowrap"><?= htmlspecialchars($lm['change_type'] ?? '-') ?></td>
