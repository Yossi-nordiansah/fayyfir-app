...
// Ambil data HPP & penyusutan tanpa menggunakan View penyusutan_tahap atau bb_v_hpp_awal
$sql = "
    SELECT 
        pa.id, b.nama_bahan, s.nama_supplier, pa.tanggal_pembelian,
        pa.berat_awal, pa.total_modal, 
        ROUND((pa.total_modal / NULLIF(pa.berat_awal, 0)), 2) AS hpp_per_kg, 
        pa.kode_batch,
    ...
    GROUP BY pa.id, b.nama_bahan, s.nama_supplier, pa.tanggal_pembelian, pa.berat_awal, pa.total_modal, pa.kode_batch
