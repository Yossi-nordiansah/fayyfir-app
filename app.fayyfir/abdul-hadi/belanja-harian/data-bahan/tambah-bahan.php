  ...
  if ($nama_bahan === "" || $satuan === "") {
    ...
    if ($check_result->num_rows > 0) {
      ...
      if ($stmt->execute()) {
        ...
        $_SESSION["success"] = "Bahan baru berhasil ditambahkan.";
...
<option value="" disabled <?= !isset($_POST['satuan']) ? 'selected' : '' ?>>Pilih Satuan</option>
<option value="Kg" <?= (($_POST['satuan'] ?? '') === 'Kg') ? 'selected' : '' ?>>Kg</option>
<option value="Ton" <?= (($_POST['satuan'] ?? '') === 'Ton') ? 'selected' : '' ?>>Ton</option>
<option value="Gram" <?= (($_POST['satuan'] ?? '') === 'Gram') ? 'selected' : '' ?>>Gram</option>
<option value="Liter" <?= (($_POST['satuan'] ?? '') === 'Liter') ? 'selected' : '' ?>>Liter</option>
<option value="Karung" <?= (($_POST['satuan'] ?? '') === 'Karung') ? 'selected' : '' ?>>Karung</option>
<option value="Sak" <?= (($_POST['satuan'] ?? '') === 'Sak') ? 'selected' : '' ?>>Sak</option>
