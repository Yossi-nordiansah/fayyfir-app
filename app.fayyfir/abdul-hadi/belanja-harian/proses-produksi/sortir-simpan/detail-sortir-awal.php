...
<main class="lg:ml-64 bg-gray-50 min-h-screen px-4 py-6 sm:px-6 lg:px-8">
  ...
  <div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-md hover:shadow-lg border border-gray-100 transition-all duration-200">
    <div class="p-6 sm:p-8">
      ...
      <div class="mt-8 border-b pb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 class="text-xl font-semibold text-gray-800">Pengeluaran <?= htmlspecialchars($data['kode_batch']) ?></h2>
          <p class="text-sm text-gray-500 mt-1">Rincian biaya pengeluaran bahan</p>
        </div>
      </div>
              ...
              ?>
                ...
                <tr class="whitespace-nowrap hover:bg-gray-50 transition">
                  ...
                  <td class="px-5 py-3 text-center">
                    ...
                    <a href="edit-pengeluaran?id_pengeluaran=<?= $row['id'] ?>&id_sortir=<?= $id ?>"        
                    ...
                    <a href="hapus-pengeluaran?id_pengeluaran=<?= $row['id'] ?>&id_sortir=<?= $id ?>"
                       onclick="return confirm('Menghapus data pengeluaran akan mempengaruhi total harga akhir/Kg. Apakah Anda yakin ingin menghapusnya?');"
      ...
      <div class="mt-10">
        <?php if ($data_lengkap): ?>
          <div class="bg-green-50 border border-green-200 rounded-2xl p-5 sm:p-6 shadow-sm hover:shadow-md transition-all duration-200">
            ...
            <dl class="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm">
              <div>
                <dt class="text-gray-500 mb-1">Berat Akhir</dt>
                <dd class="font-semibold text-gray-900"><?= format_angka($berat_setelah_3) ?> kg</dd>
              </div>
              <div>
                <dt class="text-gray-500 mb-1">Total Penyusutan</dt>
                <dd class="font-semibold text-gray-900"><?= format_persen($penyusutan_total) ?></dd>
              </div>
              <div>
                <dt class="text-gray-500 mb-1">Total Harga Akhir / Kg</dt>
                <dd class="font-semibold text-gray-900"><?= format_rupiah($harga_akhir_perkg) ?>/Kg</dd>
              </div>
              <div>
                <dt class="text-gray-500 mb-1">Total Modal Akhir</dt>
                <dd class="font-semibold text-gray-900"><?= format_rupiah($total_modal_akhir) ?></dd>
              </div>
            </dl>
          </div>
        <?php else: ?>
          <div class="bg-red-50 border border-red-200 rounded-2xl p-5 sm:p-6 shadow-sm">
            ...
            <p class="text-sm text-red-600 leading-relaxed">
              Rekap akhir belum dapat dihitung karena salah satu data berikut belum lengkap:
              berat akhir, harga proses akhir, atau biaya pengeluaran.
              <br>Lengkapi seluruh data agar sistem dapat menampilkan total harga dan modal akhir batch ini.
            </p>
          </div>
        <?php endif; ?>
      </div>
