                ...
                <tr class="<?= $rowClass ?>">
                  ...
                  <td class="px-4 py-2 text-center whitespace-nowrap">
                    <div class="flex justify-between items-center gap-2">
                      ...
                      <!-- Preview Invoice PDF -->
                      <a href="transaksi-invoice.php?invoice=<?= urlencode($h['invoice_number']) ?>" class="text-blue-600 hover:text-blue-800" target="_blank" title="Preview Invoice PDF">
                        <span class="material-symbols-outlined text-base">picture_as_pdf</span>
                      </a>
                      <!-- Download Invoice PDF -->
                      <a href="transaksi-invoice.php?invoice=<?= urlencode($h['invoice_number']) ?>&download=1" class="text-green-600 hover:text-green-800" title="Download Invoice PDF">
