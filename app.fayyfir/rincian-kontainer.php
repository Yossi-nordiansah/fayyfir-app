...
<body class="bg-gray-100 text-gray-800 min-h-screen">
  <header class="bg-gray-900 text-white py-4 px-6 fixed top-0 left-0 right-0 z-40">
    <div class="flex justify-between items-center">
      <?php if (isset($kontainer) && $kontainer["status"] === "draft" || $kontainer["status"] === "full"): ?>
  ...
  <main class="pt-20 px-4 pb-32 max-w-6xl mx-auto">
    ...
    <!-- Button Full -->
    <?php if (isset($kontainer) && $kontainer["status"] === "draft"): ?>
  ...
  <script>
    ...
    function showTrxModalAdmin(data) {
      ...
      document.getElementById('modal-berat').innerText = data.berat;
